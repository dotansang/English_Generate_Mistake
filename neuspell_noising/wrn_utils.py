...
def _load_assorted_mistakes(file_path):
    """load assorted mistakes neuspell; a dict of vocab along with the number of possible replacement candidates
    """
...
def noisyfy_word_tokens(original_sentences,
    ...
    # print("------------------------------------")
    # prob can be calculated as prob*overlap = 15% as a standard
